...
public interface PartitionFunction<DATA> {
	 ...
	 * 
	 * @param promoted         The pair of data objects that will guide the
	 *                         partition
	 *                         process.
	 ...
	 */
	Pair<Set<DATA>> process(Pair<DATA> promoted, Set<DATA> dataSet, DistanceFunction distanceFunction);
